...
obj <- findmarkergene(object = obj, species = opt$species, marker = cellmatch, tissue = opt$tissue)
...
write.table(compare_result, file = paste(opt$outdir, "scCATCH_anno.csv", sep = ""), sep = ",", quote = F, col.names = T, row.names = F)
